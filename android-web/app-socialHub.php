...
<body>
 ...
 <div class="list-group-item" style="background-color:#e7e7e7;">
 <div><span style="font-size:16px;"><b>Social Hub</b></span> is a platform to connect and interact 
 with people and participating in Activities.</div>
 </div>
 </div>
 ...
 It is a point where classmates can connect and share the Activities. 
 </div>
 </div>
 </div> 
 </div>
