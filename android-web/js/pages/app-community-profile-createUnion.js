...
function set_data_communityProfile(){
 ...
 UNION_NAME = sentenceCase(document.getElementById("add_"+USR_LANG+"_unionName").value);
 ...
 MYDESIGNATION_TITLE = sentenceCase(document.getElementById("add_"+USR_LANG+"_mydesignation").value); 
