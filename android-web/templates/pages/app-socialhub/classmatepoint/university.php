 <div class="row">
    <div class="col-xs-12 mbot15p">
	  <a href="<?php echo $_SESSION["PROJECT_URL"]; ?>app/socialHub/classmatepoint/institution/create" class="a-custom">
       <button class="btn btn-default pull-right"><b>(+) Create University</b></button>
	  </a>
    </div>
 </div>
 <div class="row">
 <div class="col-xs-12">
	...
	<div class="list-group-item pad0">
	  ...
	  <div align="center" class="col-xs-12">
	    <div><img src="<?php echo $_SESSION["PROJECT_URL"]; ?>images/logo-blue.jpg" class="profile_pic_img3"/></div>
