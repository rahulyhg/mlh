<!-- Accept Local Community Branch ::: START -->
<div class="panel panel-success">
  <div class="panel-heading pad2-8">
    <h5><b>Accept Local Community Branch</b></h5>
  </div>
  <div class="panel-body">
    ...
    <div class="form-group">
      ...
      <select id="notifyTesting_acceptLocalBranch_communityId" class="form-control">
         <option value="">Select Community Name</option>
      </select>
    </div> 
    <div class="form-group">
      <label>From User Id</label>  
      <select id="notifyTesting_acceptLocalBranch_userId" class="form-control">
         <option value="">Select User Id</option>
      </select>
    </div>
    <div class="form-group">
      <label>Country</label>  
      <select id="notifyTesting_acceptLocalBranch_country" class="form-control"
    ...
    <div class="form-group">
      <label>State</label>  
      <select id="notifyTesting_acceptLocalBranch_state" class="form-control"
    ...
    <div class="form-group">
      ...
      <select id="notifyTesting_acceptLocalBranch_location" class="form-control"
   ...
   <div class="form-group">
     ...
     <select id="notifyTesting_acceptLocalBranch_locality" class="form-control">
...
<!-- Accept Local Community Branch ::: END -->