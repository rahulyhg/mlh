...
public class NewsFeedIntervalWebService extends AsyncTask<String, String, String> {
	/* Checks for the NewsFeed that user doesn't watched and pushes Notification */
	private final static String USER_AGENT = "Mozilla/5.0";
	Context context;
	public NewsFeedIntervalWebService(Context context){
