...
public class UnWatchedNotificationServiceBean {
	private List<UnWatchedNotify> latestNotify = null;
	  public List<UnWatchedNotify> getLatestNotify() { return latestNotify; }
	  public void setLatestNotify(List<UnWatchedNotify> latestNotify) { this.latestNotify = latestNotify; }
	  public class UnWatchedNotify {
